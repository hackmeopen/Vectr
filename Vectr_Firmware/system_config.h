...
#define PLAY_IN_IS_HIGH !PLIB_PORTS_PinGet(PORTS_ID_0, PLAY_IN_PORT, PLAY_IN_PIN)
#define REC_IN_IS_HIGH  !PLIB_PORTS_PinGet(PORTS_ID_0, RECORD_IN_PORT, RECORD_IN_PIN)
